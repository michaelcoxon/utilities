import { testLogVerbosity, LogLevel } from '../src/Logging';
import { expect, assert } from 'chai';
import 'mocha';

function testLogVerbosityTest(expect: boolean, desiredLevel: LogLevel, loggingVerbosity: LogLevel)
{
    let actual = testLogVerbosity(desiredLevel, loggingVerbosity);
